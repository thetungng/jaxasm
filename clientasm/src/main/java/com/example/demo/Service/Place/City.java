...
public class City  implements java.io.Serializable {
    ...
    private com.example.demo.Service.Place.Place[] places;
    ...
    public City(
           ...
           com.example.demo.Service.Place.Place[] places) {
           this.id = id;
           this.name = name;
           this.places = places;
    }
     ...
     * @return places
     */
    public com.example.demo.Service.Place.Place[] getPlaces() {
        return places;
    }
     ...
     * @param places
     */
    public void setPlaces(com.example.demo.Service.Place.Place[] places) {
        this.places = places;
    }

    public com.example.demo.Service.Place.Place getPlaces(int i) {
        return this.places[i];
    }

    public void setPlaces(int i, com.example.demo.Service.Place.Place _value) {
